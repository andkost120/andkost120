...
- headless cms: Prismic, Strapi, Contentful, WordPress, Ghost, Sanity, Netlify CMS
- node.js/express, php/laravel
- mysql/mariadb/postgres/mongodb
- docker, git, jira, slack, figma, firebase
